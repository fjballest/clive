...
yydefault:
	...
	case 10:
		...
		//line parse.y:69
		{
			...
			yyVAL.nd.Args = append([]string{yyDollar[2].sval}, yyVAL.nd.Args...)
		}
	case 11:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line parse.y:74
	...
	case 38:
		...
		//line parse.y:212
		{
			yyVAL.nd = newNd(Nredir, "<", yyDollar[1].sval).Add(yyDollar[2].nd)
		}
	case 39:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line parse.y:216
